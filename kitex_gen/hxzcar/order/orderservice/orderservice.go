...
var serviceMethods = map[string]kitex.MethodInfo{
	...
	"AssignDriver": kitex.NewMethodInfo(
		assignDriverHandler,
		newOrderServiceAssignDriverArgs,
		newOrderServiceAssignDriverResult,
		false,
		kitex.WithStreamingMode(kitex.StreamingNone),
	),
}
...
func assignDriverHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*order.OrderServiceAssignDriverArgs)
	realResult := result.(*order.OrderServiceAssignDriverResult)
	success, err := handler.(order.OrderService).AssignDriver(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newOrderServiceAssignDriverArgs() interface{} {
	return order.NewOrderServiceAssignDriverArgs()
}

func newOrderServiceAssignDriverResult() interface{} {
	return order.NewOrderServiceAssignDriverResult()
}
...
func (p *kClient) AssignDriver(ctx context.Context, req *order.AssignDriverReq) (r *order.AssignDriverResp, err error) {
	var _args order.OrderServiceAssignDriverArgs
	_args.Req = req
	var _result order.OrderServiceAssignDriverResult
	if err = p.c.Call(ctx, "AssignDriver", &_args, &_result); err != nil {
		return
	}
	return _result.GetSuccess(), nil
}
